...
for min_samples in min_samples_list:
    ...
    results_neighbouring_mms.append(find_best_epsilon_neighboring(X_normalized, min_samples))
    results_neighbouring_ss.append(find_best_epsilon_neighboring(X_normalized, min_samples))
...
# define two partial function
find_best_min_samples_scipy_fixed_X_ss = functools.partial(find_best_min_samples_scipy, X_normalized)
find_best_min_samples_scipy_fixed_X_mms = functools.partial(find_best_min_samples_scipy, X_normalized)
...
# evaluate
DBSCAN_dict = running_DBSCAN(X_normalized, eps_list_mss, [10,10,10,10,10])
evaluate_Algorithm(X_normalized, DBSCAN_dict, "DBSCAN")
