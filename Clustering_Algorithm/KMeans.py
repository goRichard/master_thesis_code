...
result_reduced = running_KMeans(X_reduced, n_clusters_list)
...
KMeans_dict_reduced = result_reduced[0]
...
# create the csv file
f1 = open("cluster_result/K-Means/kmeans_score_reduced.csv", "w")
...
KMeans_list_1 = evaluate_Algorithm(X_epanet, KMeans_dict_reduced, "KMeans")
