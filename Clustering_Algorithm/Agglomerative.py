...
Agg_dict_adjacency = running_agg_with_connectivity_matrix(X_normalized, n_clusters_list, "adjacency")
...
# create the csv file
f1 = open("agg_score_adjacency.csv", "w")
f2 = open("agg_score_adjacency_mms.csv", "w")
f3 = open("agg_score_W_knn.csv", "w")
f4 = open("agg_score_W_knn_mms.csv", "w")
f5 = open("agg_score_W.csv", "w")
f6 = open("agg_score_W_mms.csv", "w")
